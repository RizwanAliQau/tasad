...
class MVTecTestDataset(Dataset):
    ...
    def __init__(self, root_dir, datatype='jpg', resize_shape=None):
        self.root_dir = root_dir
        self.images = sorted(glob.glob(root_dir+f"*.{datatype}")) ### actual : png"))"*.jpg"/*/*.jpg
...
class MVTecDRAEMTrainDataset(Dataset):
    ...
    def __init__(self, root_dir, anomaly_source_path, resize_shape=None):
        ...
        self.image_paths = sorted(glob.glob(root_dir+"*.png")) ### change /*/*.jpg
